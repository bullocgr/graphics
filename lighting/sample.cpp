...
GLuint 	coneList;				// list to hold the cone
...
GLuint 	sphereList;				// list for the sphere
GLuint 	octList;				//list for the second sphere
float   rotation_angle;			// angle of rotation
float	octAngle;				//angle of the oct object
float   White[ ] = { 1.,1.,1.,0.5 };
float   Blue[ ] = { 0.,0.,1.,0.5 };
float   Green[ ] = { 0.,1.,0.,0.5 };
...
Display( )
{
	...
	if( Light0On ) {
		...
		SetSpotLight( GL_LIGHT0, 0., 1., 0., 2., 0., 0., 0., 1., 0.);
	}
	else {
	...
	glMaterialfv( GL_FRONT, GL_SPECULAR, MulArray3( .7, Purple )); 
	glMaterialf ( GL_FRONT, GL_SHININESS, 8. );
	glMaterialfv( GL_FRONT, GL_EMISSION, Array3( 0., 0., 0. ) );
	glRotatef(360.* rotation_angle, 0.,1.,0.);
	glTranslatef (1.5, 1., 0.);
	// SetSpotLight( GL_LIGHT1, 0., 0., 0., -1.5, -1., 0., 0., 1., 0.);
	...
	glMaterialfv( GL_FRONT, GL_AMBIENT, MulArray3( 1., White ) ); 
	glMaterialfv( GL_FRONT, GL_DIFFUSE, MulArray3( 1., Purple )); 
	glMaterialfv( GL_FRONT, GL_SPECULAR, MulArray3( .7, Green )); 
	glMaterialf ( GL_FRONT, GL_SHININESS, 8. );
	glMaterialfv( GL_FRONT, GL_EMISSION, Array3( 0., 0., 0. ) );
	glRotatef(360.*octAngle, 0.,0.,1.);
	glTranslatef(2.5,0.,0.);
	glScalef(.5,.5,.5);


	if( Light2On ) {
		SetSpotLight( GL_LIGHT2, 0., 0., 0., -2.5, 0., 0., 1., 0., 1.);
...
InitLists( )
{
	...
	octList = glGenLists( 1 );
	glNewList( octList, GL_COMPILE );
		glColor3f(1., 0., 1.);
